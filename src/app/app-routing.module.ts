...
{ path:'dashboard',component:DashboardComponent,canActivate:[AuthGuard], 
  ...
  children: 
    [
      { path:'bayhome', component:BayhomeComponent,},
      ...
      { path: 'movetools', component: MovetoolsComponent},
      { path:'toolinfo/:id', component: TooinfoComponent},
      { path: 'reporttable', component: ReporttableComponent},
      { path: 'projects', component: ProjectsComponent},
      { path: 'users', component: UsersComponent},
      { path: 'labtrend', component: LabtrendComponent}
    ],    
},
