...
export class CategorytableComponent implements OnInit {
  ...
  constructor(private _service:DataService, private _orderPipe: OrderPipe, private ms:MomentService){
  }
...
function formatDate(date) {
  ...
  callDateInitial(start, end){
    let category:object;
    category={start_date:start.format('YYYY-MM-DD'), end_date:end.format('YYYY-MM-DD')
  };
  ...
  callDateApply(ev, picker){
    let category:object;
    category={start_date:picker.startDate.format('YYYY-MM-DD'),end_date:picker.endDate.format('YYYY-MM-DD')
  };
