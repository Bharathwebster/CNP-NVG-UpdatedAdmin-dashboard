...
export class DashboardhomeComponent implements OnInit,OnDestroy {
  ...
  swapTools(data){
    ...
    type baytool1 = {bay: number, bay_number:string, id:number};
    type baytool2 = {bay: number, bay_number:string, id:number};
    type baytoolarray = {too1:any,too2:any};

    var arr1: baytool1 = {bay: data.too1.bay, bay_number: data.too1.bay_number,id:data.too1.id}
    var arr2: baytool2 = {bay: data.too2.bay, bay_number: data.too2.bay_number,id:data.too2.id}
